...
<body>
        ...
        <header class="header">
			<nav class="navbar navbar-expand-lg navbar-light" id="main-navbar">
				<div class="container-fluid">
					<!-- Navbar Brand start -->
					<a class="navbar-brand col-md-3 d-flex align-items-center" href="#"><img class="logo" src="../images/logo.png" alt="" /><div class="navbar-toggle" onClick="responsiveMenu()"></div>					</a>
					<!-- Navbar Brand end -->
					...
					<ul class="navbar-nav col-md-9" id="main-menu">
						...
						<li class="nav-item"><a class="nav-link" href="#review">TARIFS</a></li>
        ...
        <div class="container-fluid d-flex align-items-center justify-content-center mr-0  ml-0 pr-0 pl-0" id="bigContainer">

                <form action="reservation.php" id="qcontainer">
                    ...
                    <div class="bg-white "id="bg-blanc">
                        ...
                        <div class="d-flex flex-column pr-5 pl-5 pt-4">
                            ...
                            <div class="d-flex align-items-center pb-4 w-100" id="tata1">
                                ...
                                <select class="input w-100"  name="" id="typeDeVol">
                                    <option value="ULM1">ULM Pendulaire</option>
                                    <option value="ULM2">ULM AutoGire</option>
                                    <option value="ULM3">Multi - Axes</option>
                                </select>
                            ...
                            <div class="d-flex align-items-center "id="tata2">
                                ...
                                <input class="input w-100" type="date" name="" id="dateR">
                        ...
                        <div class="d-flex justify-content-center align-items-center p-4">
                            ...
                            <input id="button" type="submit" class="text-white" value="Envoyer">
